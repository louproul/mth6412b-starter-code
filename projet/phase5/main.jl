...
filename_stsp = "alaska-railroad.tsp"
...
W2, HK_Graph = HK_MST(Main_Graph, 1, Main_Graph.nodes[1], 3, 1000) # method::Int64=0, t_step::Float64 = -1.0, stop_method::Int64 = 0)
...
new_W = Improve_path!(New_TSP, Main_Graph, new_W)
println("The weight of TSP Tour: ", new_W)
...
input_img = "alaska-railroad.png"
inputpath_to_stsp = "images\\shuffled"
inputpath = joinpath(root, inputpath_to_stsp) 
inputpath = joinpath(inputpath, input_img) 

write_tour("alaska-railroad.tour", node_tour, convert(Float32, W2))
reconstruct_picture("alaska-railroad.tour", inputpath, "constructed_alaska-railroad.png"; view = true)
